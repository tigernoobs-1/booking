...
import WorkOrderForm from '../workflow/form/WorkOrderForm.vue'
...
import DetailsPanel from '../workflow/DetailsPanel.vue'
...
const filterData = () => {
  ...
  console.log(facilitiesData.value.facility)
}

// 👉 Fetching facilities
const fetchFacilities = () => {
  facilityListStore.fetchAdminWork().then(response => {
...
<template>
  <section v-if="facilitiesData">
    ...
    <!-- 👉 Add New User -->
    <WorkOrderForm v-model:isDrawerOpen="isAddNewUserDrawerVisible" :title="formTitle" :role='formRole'
